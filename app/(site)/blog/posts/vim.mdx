...
summary: >-
  Discover why Vim, with its steep learning curve, remains a beloved tool among
  developers for editing code efficiently and effectively.
---
...
<Table data={{
    ...
    rows: [
      ["Value 1", "Value 2", "Empty"],
      ["Value 1", "Value 2", "Another value"],
    ],
  }} />
...
![](/uploads/nasa-hubble-space-telescope-gd7zj8iSDxc-unsplash.jpg "")

Even for MDX components!
